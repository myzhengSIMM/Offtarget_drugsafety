...
class Evaluator(object):
  ...
  def __init__(self, model, dataset: "dc.data.Dataset",
    ...
    # self.ecfpdataset = ecfpdataset
    self.ecfpdict = ecfpdict
  ...
  def compute_model_performance(
    ...
    #y_pred = self.model.predict(self.dataset, self.ecfpdataset, self.output_transformers)
    y_pred = self.model.predict(self.dataset, self.ecfpdict, self.output_transformers)
    n_tasks = len(self.dataset.get_task_names())
